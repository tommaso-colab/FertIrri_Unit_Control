...
// $todayFormat_irriframe = date("Y-m-d", time() + 86400*3);
...
$ID_sequenzaDelPROGRAMMA = 1; // id della sequenza del programma (ogni programma attiva o più valvole in sequenza o gruppi ma non mi riesce far attivare valvole diverse per dare orari diversi quindi faccio un programma ogni gruppo di valvole
